...
SELECT 'Hello Java Green';

-- Use a SELECT statement to add two numbers together 
-- The AS gives the value a name - my_number (and label the result "my_number")
SELECT 2 * 6 AS my_number;
...
SELECT city_name, area FROM city WHERE area < 25 AND population > 100000;
...
-- ends with an A/a, ILIKE is case insensitive
SELECT city_name FROM city WHERE city_name ILIKE '%A';
