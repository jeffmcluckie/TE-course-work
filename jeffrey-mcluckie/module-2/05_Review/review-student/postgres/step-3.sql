...
SELECT reservation_id, site_id, name, from_date, to_date FROM reservation WHERE from_date >= '2021-10-01' AND from_date <= '2021-10-31';
-- select all columns from reservation where name includes 'Reservation'
SELECT * FROM reservation WHERE name LIKE '%Reservation' OR name LIKE 'Reservation%';
...
SELECT from_date, COUNT(reservation_id) FROM reservation GROUP BY from_date ORDER BY from_date;
