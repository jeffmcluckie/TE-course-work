...
public class JdbcUserDao implements UserDao {
    ...
    public User saveUser(String userName, String password) {
        ...
        String sql = "INSERT INTO users(username, password, salt) VALUES (?, ?, ?) RETURNING id";
        long newId = jdbcTemplate.queryForObject(sql, Long.class, userName,
    ...
    public boolean isUsernameAndPasswordValid(String userName, String password) {
        // TODO - fixed so we use prepared statement to prevent injection attack
