...
public class HotelController {
    ...
    public void delete(@PathVariable int id, Principal principal) throws ReservationNotFoundException {
        // DO NOT take in your logged in username from the request in any way BUT this JWT token
        // and we get that info from Spring through the principal - this is Spring magic
