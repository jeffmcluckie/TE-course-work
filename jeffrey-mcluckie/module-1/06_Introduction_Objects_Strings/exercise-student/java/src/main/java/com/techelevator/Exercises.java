...
public class Exercises {
	...
	public boolean doubleX(String str) {
		...
		for (int i = 0; i < strArray.length; i++) {
			if (strArray[i].equals("x")) {
				if (((i + 1) < strArray.length) && !"x".equals(strArray[i + 1])) {
					return false;
				}
				if (((i + 1) < strArray.length) && strArray[i + 1].equals("x")) {
					return true;
				}
			}
		}
	...
	public int last2(String str) {
		...
		for (int i = 0; i < strArray.length; i++) {
			if(strArray.length < 4){
				...
				if (((i + 2) <= strArray.length) && str.substring(i, i + 2).equals(str.substring(strArray.length - 2, strArray.length))){
					count += 1;
				}
	...
	public String stringX(String str) {
		...
		for (int i = 0; i < strArray.length; i++) {
			...
			if(strArray[0].equals("x") && i == 0){
				emptyString += "x";
			}
			if(!"x".equals(strArray[i])){
				emptyString += strArray[i];
			}
			if(strArray[strArray.length - 1].equals("x") && i == strArray.length - 1){
				emptyString += "x";
			}
		}
		return emptyString;
	...
	public String stringYak(String str) {
		String replacement = str.replace("yak", "");
		return replacement;
			}
