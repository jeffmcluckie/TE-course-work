...
public class Lecture {
    ...
    */
    public boolean returnTrueFromIf() {
        ...
        return false;  // We will never get to this line, return in if exits function
    }
    ...
    */
    ...
    /*
    11. Write an if statement that returns "Fizz" if the parameter is 3 and returns an
...
//        return "";
    ...
    */
    ...
    /*
    15. Now, do it again with a different boolean operation (operator).
    */
...
//        if (! (number >= 18) ) { // Try not to use ! NOT in your code
//            return "Adult";
//        } else {
//            return "Minor";
//        }
