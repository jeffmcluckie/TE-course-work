...
public class Lecture {
    ...
    */
    public int returnLastElement() {
        int[] portNumbers = { 80, 8080, 443 };
        // return portNumbers[2]; // works if you know the size

        // What if you don't know the size? This always works for last position/index
    ...
    */
    ...
    /*
    10. This loop is counting incorrectly. What needs to change in the loop for it
        to count properly?
    */
    ...
    /*
    11. This loop is counting incorrectly. What needs to change in the loop for it
        to count properly?
    */
